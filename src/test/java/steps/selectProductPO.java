...
public class selectProductPO {
    // Atributos
    final WebDriver driver; // Este é o objeto final do Selenium (uma unica bola em campo)
    ...
    public static void before_all(){
        ...
        basePage = new BasePage(this.driver);              // Instanciar Base com driver
        homePage = new HomePage(this.driver);               // Instanciar Home com driver
    ...
    public static void after_all() throws InterruptedException {
        ...
        //Thread.sleep(3000);
        basePage.driver.findElement(By.cssSelector("button.btn.btn_secondary.btn_small.cart_button")).click();
