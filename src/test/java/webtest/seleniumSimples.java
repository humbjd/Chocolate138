...
public class seleniumSimples {
    ...
    public void setUp(){
        ...
        WebDriverManager.chromedriver().setup(); // Download e instalação do driver do Chromedriver

        // Configurar as opções para o driver do navegador (a partir do Selenium 4.8.0)
        ChromeOptions options = new ChromeOptions(); // objeto de configuração para o Chromedriver
        ...
        driver = new ChromeDriver(options); // Instancia o Selenium como Chromedriver com opções
